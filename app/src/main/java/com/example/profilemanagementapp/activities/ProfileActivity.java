...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEditProfile.setOnClickListener(v -> startActivity(new Intent(this, EditProfileActivity.class).putExtra("userId", userId)));
        btnViewDiary.setOnClickListener(v -> startActivity(new Intent(this, DiaryActivity.class).putExtra("userId", userId)));
